...
class FSServer {
    ...
    public void connect() throws IOException {
        ...
        //this.brd = new BufferedReader(new InputStreamReader(this.sis));

        this.sos = sck.getOutputStream();
        //this.dos = new DataOutputStream(sos);
    }
    ...
    public String getLinePacket() throws IOException {
        ...
        while (true) {
            ...
            if (c == 0x00 || c == '\n') {
                if (c == 0x00) {
                    System.err.println("ZERO-TERMINATED STRING RXD!");
                }
                sw.append('\n');

                if (sw.toString().equals("\n") || sw.toString().equals("\r\n")) {
                    // is this right?
                    System.err.println("READ-STRING SLIP-TROUGHT!");
